...
class YOLOv8Seg:
    ...
    def masks2segments(masks):
        ...
        https://github.com/JustAGek/yolov12-course-project/blob/main/ultralytics/utils/ops.py.
    ...
    def process_mask(self, protos, masks_in, bboxes, im0_shape):
        ...
        quality but is slower, from https://github.com/JustAGek/yolov12-course-project/blob/main/ultralytics/utils/ops.py.
